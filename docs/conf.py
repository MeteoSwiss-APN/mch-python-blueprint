...
project = "MCH Python Blueprint"
copyright = "2022, MeteoSwiss-APN"
author = "MeteoSwiss-APN"
...
man_pages = [
    (master_doc, "APN Python Blueprint", "Blueprint Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        master_doc,
        "APN Python Blueprint",
        "Blueprint Documentation",
        author,
        "APN Python Blueprint",
        "Create your Python packages from templates.",
        "Miscellaneous",
    ),
]
